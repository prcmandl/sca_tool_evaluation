...
from evaluation.analysis.plots import plot_recall
...
with open("${EXPERIMENT_DIR}/stats.json", "w") as f:
    json.dump({"metrics": agg, "significance": sig}, f, indent=2)

plot_recall(agg, "${EXPERIMENT_DIR}")
