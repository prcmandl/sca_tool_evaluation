...
from core.tools import tool_file_id

# ------------------------------------------------------------
# Adapters to tool and database APIs
# ----------------------------------------------------------
from adapters.dtrack import DependencyTrackAdapter
from adapters.evaltech import EvaltechAdapter
from adapters.osv import OSVAdapter
from adapters.github_advisory import GitHubAdvisoryAdapter
from adapters.nvd import NVDAdapter
from adapters.fossa import FossaAdapter
from adapters.snyk import SnykAdapter
from adapters.oss_index import OSSIndexAdapter

from core.ground_truth import load_ground_truth
from core.fp_classification import classify_fp_candidate
from core.model import Finding
from reporting.dump_tool_findings import dump_tool_findings_csv
from reporting.evaluation_report import write_report
from core.version_matching import version_in_range
from reporting.tool_findings_txt import write_tool_findings_txt
...
def main() -> None:
    ...
    # Further analysis
    # --------------------------------------------------------
    from analysis.tool_findings import analyze_tool_findings
